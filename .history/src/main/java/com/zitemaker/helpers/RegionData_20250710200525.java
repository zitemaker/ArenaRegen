...
public class RegionData {
    ...
    private long streamingHeaderPos = 0;
    ...
    public void startStreamingDatc(File datcFile) throws IOException {
        ...
        // Reserve space for section count (will fix up at the end)
        streamingHeaderPos = ((GZIPOutputStream) streamingDos.out).size();
        streamingDos.writeInt(0); // placeholder for section count
