...
public class RegionData {
    ...
    /**
     * Sets the datcFile reference. Pure data, can be called async.
     */
    ...
    /**
     * Sets the spawn location. Bukkit Location is not thread-safe, so main thread only.
     */
    ...
    /**
     * Sets the locked state and marks region dirty. Main thread only.
     */
    ...
    /**
     * Adds a block to a section and captures banner/sign state if present. Main thread only.
     */
    ...
    /**
     * Adds a section of blocks. Main thread only.
     */
    ...
    /**
     * Sets region metadata. Main thread only (may mark region dirty).
     */
    ...
    /**
     * Marks a block as modified. Main thread only.
     */
    ...
    /**
     * Clears all modified blocks. Main thread only.
     */
    ...
    /**
     * Returns a copy of modified blocks. Thread-safe.
     */
    ...
    /**
     * Adds an entity's serialized data. Main thread only.
     */
    ...
    /**
     * Returns a copy of entity data map. Thread-safe.
     */
    ...
    /**
     * Clears all entities. Main thread only.
     */
    ...
    /**
     * Returns a copy of banner states. Thread-safe.
     */
    ...
    /**
     * Clears all banners. Main thread only.
     */
    ...
    /**
     * Returns a copy of sign states. Thread-safe.
     */
    ...
    /**
     * Clears all signs. Main thread only.
     */
    ...
    /**
     * Clears all region data for a region. Main thread only.
     */
