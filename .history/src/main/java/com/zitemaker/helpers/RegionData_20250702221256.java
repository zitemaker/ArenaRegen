...
public class RegionData {
    ...
    /**
     * Now fully async: ensureBlockDataLoaded runs asynchronously and returns a CompletableFuture<Void>.
     */
    ...
    // Optionally, keep the old async alias for compatibility
    @Deprecated
    public CompletableFuture<Void> ensureBlockDataLoadedAsync() {
        return ensureBlockDataLoaded();
    }
