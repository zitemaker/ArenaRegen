...
public class RegionData {
    ...
    public CompletableFuture<Void> setLocked(boolean locked) {
    ...
    public CompletableFuture<Location> getSpawnLocationAsync() {
        return CompletableFuture.supplyAsync(() -> spawnLocation != null ? spawnLocation.clone() : null);
    }
    ...
    public CompletableFuture<Map<Location, BlockData>> getModifiedBlocksAsync() {
        return CompletableFuture.supplyAsync(() -> new HashMap<>(modifiedBlocks));
    }
        ...
        return CompletableFuture.runAsync(() -> {
            ...
            for (Map.Entry<String, Object> entry : serializedEntity.entrySet()) {
                ...
                if (value instanceof ItemStack) {
                    ...
                    String joined = vec.stream().map(Object::toString).collect(java.util.stream.Collectors.joining(","));
    ...
    public CompletableFuture<Map<Location, Map<String, Object>>> getEntityDataMapAsync() {
        return CompletableFuture.supplyAsync(() -> new HashMap<>(entityDataMap));
    }
    ...
    public CompletableFuture<Map<Location, Map<String, Object>>> getBannerStatesAsync() {
        return CompletableFuture.supplyAsync(() -> new HashMap<>(bannerStates));
    }
    ...
    public CompletableFuture<Map<Location, Map<String, Object>>> getSignStatesAsync() {
        return CompletableFuture.supplyAsync(() -> new HashMap<>(signStates));
    }
    ...
    public CompletableFuture<Map<String, Map<Location, BlockData>>> getSectionedBlockDataAsync() {
        return CompletableFuture.supplyAsync(() -> new HashMap<>(sectionedBlockData));
    }

    public CompletableFuture<Map<Location, BlockData>> getAllBlocksAsync() {
        return CompletableFuture.supplyAsync(() -> {
            Map<Location, BlockData> all = new HashMap<>();
    ...
    public CompletableFuture<Boolean> isLockedAsync() {
        return CompletableFuture.supplyAsync(() -> locked);
    }

    public CompletableFuture<String> getCreatorAsync() {
        return CompletableFuture.supplyAsync(() -> creator);
    }

    public CompletableFuture<Long> getCreationDateAsync() {
        return CompletableFuture.supplyAsync(() -> creationDate);
    }

    public CompletableFuture<String> getWorldNameAsync() {
        return CompletableFuture.supplyAsync(() -> worldName);
    }

    public CompletableFuture<String> getMinecraftVersionAsync() {
        return CompletableFuture.supplyAsync(() -> minecraftVersion);
    }

    public CompletableFuture<String> getFileFormatVersionAsync() {
        return CompletableFuture.supplyAsync(() -> fileFormatVersion);
    }

    public CompletableFuture<Integer> getMinXAsync() {
        return CompletableFuture.supplyAsync(() -> minX);
    }

    public CompletableFuture<Integer> getMinYAsync() {
        return CompletableFuture.supplyAsync(() -> minY);
    }

    public CompletableFuture<Integer> getMinZAsync() {
        return CompletableFuture.supplyAsync(() -> minZ);
    }

    public CompletableFuture<Integer> getMaxXAsync() {
        return CompletableFuture.supplyAsync(() -> minX + width - 1);
    }

    public CompletableFuture<Integer> getMaxYAsync() {
        return CompletableFuture.supplyAsync(() -> minY + height - 1);
    }

    public CompletableFuture<Integer> getMaxZAsync() {
        return CompletableFuture.supplyAsync(() -> minZ + depth - 1);
    }

    public CompletableFuture<Integer> getWidthAsync() {
        return CompletableFuture.supplyAsync(() -> width);
    }

    public CompletableFuture<Integer> getHeightAsync() {
        return CompletableFuture.supplyAsync(() -> height);
    }

    public CompletableFuture<Integer> getDepthAsync() {
        return CompletableFuture.supplyAsync(() -> depth);
    }

    public CompletableFuture<File> getDatcFileAsync() {
        return CompletableFuture.supplyAsync(() -> datcFile);
    }

    public CompletableFuture<Long> getAreaAsync() {
        return CompletableFuture.supplyAsync(() -> (long) width * height * depth);
    }
