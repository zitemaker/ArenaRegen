...
public class ArenaRegen extends JavaPlugin{
    ...
    public void saveRegionsAsync() {
        ...
        for (String regionName : regionsToProcess) {
            ...
            boolean isEmpty = region == null || (region.sectionedBlockData.isEmpty() && region.entityDataMap.isEmpty() && region.bannerStates.isEmpty() && region.signStates.isEmpty() && region.modifiedBlocks.isEmpty());
            if (isEmpty) {
                continue;
            }
