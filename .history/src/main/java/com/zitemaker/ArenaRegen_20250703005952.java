...
public class ArenaRegen extends JavaPlugin{
    ...
    public void saveRegionsAsync() {
        ...
        for (String regionName : regionsToProcess) {
            ...
            boolean isEmpty = region == null || (region.sectionedBlockData.isEmpty() && region.getEntityDataMap().isEmpty() && region.getBannerStates().isEmpty() && region.getSignStates().isEmpty() && region.getModifiedBlocks().isEmpty());
            if (isEmpty) {
                continue;
            }
