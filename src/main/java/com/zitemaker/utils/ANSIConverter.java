...
public class ANSIConverter {
    private static final Map<ARChatColor, String> replacements = Helpers.suppliedMap(ARChatColor.class, e -> switch (e) {
        case BLACK -> "\u001B[30;22m";
